            ...
            <table class="table table-striped table-hover">
               ...
               ?>
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="?s=admin/grade/show&id=<?php echo $v['id']?>" class="btn btn-info">查看</a>
                                <a href="?s=admin/grade/edit&id=<?php echo $v['id']?>" class="btn btn-primary">编辑</a>
    ...
    <script>
         function del(k) {
             if(confirm('确定删除该班级数据吗?')){
                 location.href = 'index.php?s=admin/grade/del&id=' + k;
             }
         }
